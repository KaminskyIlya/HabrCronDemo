 ...
 * От себя добавил счетчик итераций и сравнений, чтобы оценить реальные итерации в худшем случае.
 *
 * Бечмарки:
 ...
 */
@Deprecated
public class ScheduleForMeasure extends CronBase
{
     ...
     */
    public ScheduleForMeasure() throws ScheduleFormatException
    {
    ...
    public ScheduleForMeasure(String schedule) throws ScheduleFormatException
    {
        if ( schedule == null )
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        ScheduleForMeasure cron = new ScheduleForMeasure();
    ...
    public int loops;  // счетчик итераций
    public int compares; // счетчик сравнений
        ...
        while (true)
        {
            ...
            if (_years[yearOffset] > 0)
            {
                ...
                if (_months[m] > 0)
                {
                    ...
                    boolean isLastDayInMonth = day == maxDays;
