...
public class RangeListTest
{
    ...
    {
        RangeList ranges = new RangeList(5);
        ranges.add(new Range(2, 6));    // 5 values: 2, 3, 4, 5, 6
        ranges.add(new Range(10, 14));  // 5 values: 10, 11, 12, 13, 14
        ranges.add(new Range(47, 51));  // 5 values: 47, 48, 48, 50, 51
        ranges.add(new Range(20, 24));  // 5
        ranges.add(new Range(30, 34));  // 5

        // Result: 2-6,10-14,20-24,30-34,47-51,
        // count = 25, distance = 51 - 2 + 1 = 50, coverage = 0.5
        assertEquals(0.5f, ranges.getCoverage());
    }
