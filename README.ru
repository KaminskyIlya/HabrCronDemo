...
подобного класса на любом удобном языке.
Делалась в рамках написания соответствующей обзорной статьи.

Пакет com.habr.cron.novar содержит java-реализацию исходного алгоритма NoVar (https://habr.com/users/NoVar)
Пакет com.habr.cron.ilya содержит эталонную реализацию улучшенного алгоритма от меня.
Пакет com.habr.cron.dev содержит сильно оптимизированную реализацию нового алгоритма.
Все алгоритмы хорошо протестированы.

Тестовая ветка com.habr.cron.speed содержит бенчмарки, для сравнения разных алгоритмов.
